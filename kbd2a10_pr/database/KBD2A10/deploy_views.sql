...
-- Trade with each client per month. This view isnt used anywhere.
...
-- The latestes  prices of each product. Used in APEX report.
AS SELECT 
...
-- Gain on each product per month. This view isnt used anywhere.
