...
generate_date()
{
	echo "to_date('`date -d "$((RANDOM%1+$1))-$((RANDOM%12+1))-$((RANDOM%28+1)) $((RANDOM%23+1)):$((RANDOM%59+1)):$((RANDOM%59+1))" '+%Y-%m-%d %H:%M:%S'`', 'YYYY-MM-DD HH24:MI:SS')"
}
...
do
	...
	echo "insert into orders values ($id, $client_id, 0, $date_received);"
